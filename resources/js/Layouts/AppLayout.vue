                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('anggota')" :active="route().current('anggota')">
                                    Anggota
                                </jet-nav-link>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('data-maps')" :active="route().current('data-maps')">
                                    Data Maps
                                </jet-nav-link>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('struktur-organisasi')"
                                              :active="route().current('struktur-organisasi')">
                                    Struktur Organisasi
                                </jet-nav-link>
                            </div>
                        </div>
