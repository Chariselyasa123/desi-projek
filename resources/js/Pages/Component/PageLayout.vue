<template>
    <div>
        ...
        <div class="bg-[url('/images/mountain.jpg')] flex flex-col h-screen justify-between">
            <!-- Landing page header -->
            <nav class="navbar-fixed-top" ref="navbar">
                <div class="flex gap-8 items-center">
                    ...
                    <nav-link :href="route('artikel')" :active="route().current('artikel')">Artikel</nav-link>
            ...
            <!--                                    </svg>-->
            <!--                                    <span-->
            <!--                                        class="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase">Ripala</span>-->
            <!--                                </a>-->
